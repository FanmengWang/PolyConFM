...
class PolyConFMPropertyTask(UnicoreTask):
    @staticmethod
    def add_args(parser):
        """Register property-task CLI arguments.
    ...
    def setup_task(cls, args, **kwargs):
        """Create property-task instance after loading dictionary resources.
        ...
        Returns:
            Initialized PolyConFMPropertyTask instance.
        """
    ...
    def load_dataset(self, split, **kwargs):
        """Build property-task inputs and regression targets from LMDB data."""
    ...
    def build_model(self, args):
        """Build property model and register classification head.

        Args:
            args: Parsed CLI/runtime arguments for model construction.

        Returns:
            Instantiated model with task-specific classification head.
        """
