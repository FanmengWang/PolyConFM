...
@register_task("polyconfm_pretrain_phase1")
class PolyConFMPretrainPhase1Task(UnicoreTask):
    @staticmethod
    def add_args(parser):
    ...
    def setup_task(cls, args, **kwargs):
        """Create task instance after loading dictionary resources.
        ...
        Returns:
            Initialized PolyConFMPretrainPhase1Task instance.
        """
    ...
    def load_dataset(self, split, **kwargs):
        """Build the phase-1 dataset pipeline from LMDB to model net_input fields."""
