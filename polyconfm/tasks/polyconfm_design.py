...
@register_task("polyconfm_design")
class PolyConFMDesignTask(UnicoreTask):
    @staticmethod
    def add_args(parser):
        """Register design-task CLI arguments.
        ...
        parser.add_argument("--task-name", type=str, default="O2-N2-CO2", help="desired properties")
    ...
    def setup_task(cls, args, **kwargs):
        """Create design-task instance after loading dictionary resources.
        ...
        Returns:
            Initialized PolyConFMDesignTask instance.
        """
    ...
    def load_dataset(self, split, **kwargs):
        """Build design-task model inputs and conditioning fields from LMDB."""
        ...
        dataset = DesignConformerDataset(
        ...
        repeat_unit_pyg_dataset = KeyDataset(dataset, "repeat_unit_pyg") # (bsz,)
        ...
        nest_dataset = NestedDictionaryDataset(
            {
                "net_input": {
                    ...
                    "repeat_unit_pyg": PygDataset(repeat_unit_pyg_dataset),
