...
logger = logging.getLogger("polyconfm.inference")


def main(args):
    """Run validation-style inference and serialize per-sample outputs."""
...
def cli_main():
    """Parse CLI options and dispatch distributed inference entrypoint."""
