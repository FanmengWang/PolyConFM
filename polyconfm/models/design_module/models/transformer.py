...
from polyconfm.models.design_module.models.layers import Attention, Mlp
from polyconfm.models.design_module.models.conditions import TimestepEmbedder, CategoricalEmbedder, ClusterContinuousEmbedder
...
class Denoiser(nn.Module):
    ...
    def forward(self, x, e, node_mask, y, t, whole_condition, unconditioned):
