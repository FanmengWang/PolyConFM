...
def _plot_simultaneous_ci(df, tukey_result, metric_name, output_dir, methods_order):
    ...
    # Save image
    save_path = os.path.join(output_dir, f'Scaffold_{property_name}_Simultaneous_CI_{metric_name}.pdf')
...
def _plot_mcsim(df, tukey_results, metric_col, output_dir, methods_order):
    ...
    save_path = os.path.join(output_dir, f'Scaffold_{property_name}_MCSim_Plot_{metric_col}.pdf')
    plt.savefig(save_path, dpi=300, bbox_inches='tight')
...
if __name__ == "__main__":
    ...
    for property_name in property_name_list:
        ...
        my_models = {
            'Uni-Mol': f'./scaffold_5x5_cv_results/{property_name}/UniMol_scaffold_5x5_cv_{property_name}_results.csv',
            'Transpolymer': f'./scaffold_5x5_cv_results/{property_name}/Transpolymer_scaffold_5x5_cv_{property_name}_results.csv',
            'MMPolymer': f'./scaffold_5x5_cv_results/{property_name}/MMPolymer_scaffold_5x5_cv_{property_name}_results.csv',
            'PolyConFM': f'./scaffold_5x5_cv_results/{property_name}/PolyConFM_scaffold_5x5_cv_{property_name}_results.csv'
        }
